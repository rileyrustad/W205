...
SELECT 
STATE, SUM(-1*NVL(NUMBER_OF_HOSPITALS_WORSE,0) + NVL(NUMBER_OF_HOSPITALS_BETTER,0))/
SUM(
(CASE WHEN NUMBER_OF_HOSPITALS_WORSE is null THEN 0 ELSE NUMBER_OF_HOSPITALS_WORSE END)+
(CASE WHEN NUMBER_OF_HOSPITALS_SAME is null THEN 0 ELSE NUMBER_OF_HOSPITALS_SAME END)+
(CASE WHEN NUMBER_OF_HOSPITALS_BETTER is null THEN 0 ELSE NUMBER_OF_HOSPITALS_BETTER END))
AS SCORE
